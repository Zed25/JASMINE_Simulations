...
public class Simulator {
    ...
    private long eventCounter;                                          /* event processed in batch counter,
                                                                           if eventCounter mod(batchSize - 1) == 0 ->
                                                                           reset batch statistics */
    private long batchSize;                                             /* number of event processed in a batch */
    private double arrival[];                                           /* arrival times array */
    private long seed;                                                  /* simulation initial seed */
    ...
    private SystemState systemState;                                    /* init system state (N1Clet, N2Clet,
                                                                           N1Cloud, N2Cloud) <- (0,0,0,0) */
    ...
    private void reset() {
        ...
        this.arrival = new double[]{START, START};  /* init arrival time for CLASS1 <- arrival[0] and CLASS2 <- arrival[1]*/
        this.eventCounter = 1;
    }
